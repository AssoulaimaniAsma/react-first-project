    ...
    <div className="HomeDiv">
      <div className="divcontent">
        ...
        <div className="adtext pl-36 pt-12 text-xl">
          ...
          {/* Bouton Explore */}
          <button className="explore ml-48 mt-5 bg-[#FD4C2A] text-white px-8 py-2 rounded-full">
            Explore →
          </button>
        </div>
      </div>
...
<div className="flex items-center justify-between w-full max-w-xl mx-auto flex-col  2xl:flex-col 2xl:items-start">
  ...
  <a href="javascript:;" className="py-2.5 px-5 h-9 block w-fit bg-[#FD4C2A] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-[#d63413] lg:mx-0"> Contact us </a>
</div>
</div>
