...
<div class="flex items-center justify-between w-full max-w-xl mx-auto flex-col  2xl:flex-col 2xl:items-start">
  <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted by food lovers across the globe. Need help? We're here to help!</p>
  <a href="javascript:;" class="py-2.5 px-5 h-9 block w-fit bg-[#FD4C2A] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-[#d63413] lg:mx-0"> Contact us </a>
</div>
</div>

<div class="lg:mx-auto text-left">
<h4 class="text-lg text-gray-900 font-medium mb-7">SavoryBites</h4>
...
<span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">pagedone</a> 2025, All rights reserved.</span>
