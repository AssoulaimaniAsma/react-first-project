...
const recommendation=[
  {id:"x", image: require("../../image/food.jpg"), name: "item x", oldPrice:200, newPrice: 140},
  {id:"y", image: require("../../image/food.jpg"), name: "item y", oldPrice:230, newPrice: 200},
  {id:"z", image: require("../../image/food.jpg"), name: "item z", oldPrice:200, newPrice: 140},
  {id:"b", image: require("../../image/food.jpg"), name: "item z", oldPrice:200, newPrice: 140}
];

const products=[
  {id:"a", image: require("../../image/food.jpg"), name: "item x", oldPrice:200, newPrice: 140},
  {id:"c", image: require("../../image/food.jpg"), name: "item y", oldPrice:230, newPrice: 200},
  {id:"d", image: require("../../image/food.jpg"), name: "item z", oldPrice:200, newPrice: 140},
  {id:"e", image: require("../../image/food.jpg"), name: "item z", oldPrice:200, newPrice: 140},
  {id:"f", image: require("../../image/food.jpg"), name: "item x", oldPrice:200, newPrice: 140},
  {id:"j", image: require("../../image/food.jpg"), name: "item y", oldPrice:230, newPrice: 200},
  {id:"h", image: require("../../image/food.jpg"), name: "item z", oldPrice:200, newPrice: 140},
  {id:"i", image: require("../../image/food.jpg"), name: "item z", oldPrice:200, newPrice: 140}
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[30px] p-8">
            ...
            <div className="flex flex-col gap-2">
              <div className="relative">
                <img className="w-full h-[220px] object-cover rounded-lg" src={MyImage2} alt="Pizza"/>
                <div className="absolute bottom-4 left-1 text-white px-4 py-2 text-xl font-bold">Pizzas</div>
              </div>
              <div className="relative">
                <img
                  className="w-full h-[220px] object-cover rounded-lg" src={MyImage3} alt="Pasta"/>
                <div className="absolute bottom-4 left-1 text-white px-4 py-2 text-xl font-bold">Pasta</div>
              </div>
            </div>

            {/* Tacos */}
            <div className="relative pr-11">
              <img className="w-full h-[450px] object-cover rounded-lg" src={MyImage4} alt="Tacos"/>
              <div className="absolute bottom-4 left-4 text-white px-4 py-2 text-xl font-bold"> Tacos</div>
            </div>
          </div>
      </div>
      ...
      <div className="Section6 ">
        ...
        <footer className="fotterPage w-full bg-[#4d1d14] text-white py-10 mt-auto">
          ...
          <ul className="text-sm  transition-all duration-500 ">
            <li className="mb-6">
              <a href="javascript:;" className="link">Home</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">About</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">Pricing</a>
            </li>
            <li>
              <a href="javascript:;" className="link">Features</a>
            </li>
          </ul>
          </div>
          ...
          <ul className="text-sm  transition-all duration-500">
            <li className="mb-6">
              <a href="javascript:;" className="link">Figma UI System</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">Icons Assets</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">Responsive Blocks</a>
            </li>
            <li>
              <a href="javascript:;" className="link">Components Library</a>
            </li>
          </ul>
          </div>
          ...
          <ul className="text-sm  transition-all duration-500">
            <li className="mb-6">
              <a href="javascript:;" className="link">FAQs</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">Quick Start</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">Documentation</a>
            </li>
            <li>
              <a href="javascript:;" className="link">User Guide</a>
            </li>
          </ul>
          </div>
          ...
          <ul className="text-sm  transition-all duration-500">
            <li className="mb-6">
              <a href="javascript:;" className="link">News</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">Tips & Tricks</a>
            </li>
            <li className="mb-6">
              <a href="javascript:;" className="link">New Updates</a>
            </li>
            <li>
              <a href="javascript:;" className="link">Events</a>
            </li>
          </ul>
          </div>
          </div>
          ...
          <div className="final_part">
            <p className="copyright">&copy; 2025 My Company. All rights reserved.</p>
          </div>
          </footer>
